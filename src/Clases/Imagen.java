...
public class Imagen extends FiguraEstandar{
    ...
    public Imagen(String ruta, int ancho, int alto, int x, int y, Color borde, Color colorRelleno, boolean direccionAdelante, boolean direccionArriba,boolean maquina) {
